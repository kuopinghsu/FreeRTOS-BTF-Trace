...
from .timeline_util import (  # noqa: F401 — star-import skips leading _
    _format_time, _format_time_trim, _get_fixed_font_family,
    _get_sans_font_family, _monospace_font, _time_label_sort_key,
)
...
def _render_workflow_analysis_html(
    ...
    from .stats_html import html_finding_cards
...
"""
    ...
    def rebuild(self, trace: Optional["BtfTrace"]) -> None:
        ...
        def _populate_distrib(blay: QVBoxLayout) -> None:
            ...
            hist_btns.addWidget(open_btn, 1)
            hist_btns.addWidget(ai_btn, 1)
