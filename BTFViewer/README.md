<h1 id="btf-trace-viewer" style="color:rgb(9,105,218);margin-bottom:0.4em">BTF Trace Viewer</h1>
...
<h2 id="features" style="color:rgb(9,105,218);border-bottom:2px solid rgba(9,105,218,0.35);padding-bottom:0.35em">Features</h2>
...
<h2 id="contents" style="color:rgb(9,105,218);border-bottom:2px solid rgba(9,105,218,0.35);padding-bottom:0.35em">Contents</h2>
...
<h2 id="quick-start" style="color:rgb(9,105,218);border-bottom:2px solid rgba(9,105,218,0.35);padding-bottom:0.35em">Quick start</h2>

<h3 id="desktop" style="color:rgb(26,127,55)">Desktop</h3>
...
<h3 id="web" style="color:rgb(26,127,55)">Web</h3>
...
<h3 id="supported-files" style="color:rgb(26,127,55)">Supported files</h3>
...
<h2 id="using-the-viewer" style="color:rgb(9,105,218);border-bottom:2px solid rgba(9,105,218,0.35);padding-bottom:0.35em">Using the viewer</h2>

Desktop and Web share the same concepts. Where behaviour differs, it is noted below.

<h3 id="view-modes-and-orientation" style="color:rgb(26,127,55)">View modes and orientation</h3>
...
<h3 id="zoom-and-pan" style="color:rgb(26,127,55)">Zoom and pan</h3>
...
<h3 id="labels-legend-and-highlight" style="color:rgb(26,127,55)">Labels, legend, and highlight</h3>
...
<h3 id="cpu-load" style="color:rgb(26,127,55)">CPU Load</h3>
...
<h3 id="cursors" style="color:rgb(26,127,55)">Cursors</h3>
...
<h3 id="marks-and-find" style="color:rgb(26,127,55)">Marks and find</h3>
...
<h3 id="multi-tab-traces" style="color:rgb(26,127,55)">Multi-tab traces</h3>
...
<h3 id="tag-and-sti-markers" style="color:rgb(26,127,55)">Tag and STI markers</h3>
...
<h2 id="analysis" style="color:rgb(9,105,218);border-bottom:2px solid rgba(9,105,218,0.35);padding-bottom:0.35em">Analysis</h2>
...
<h3 id="analysis-findings" style="color:rgb(26,127,55)">Analysis Findings</h3>
...
<h3 id="how-to-find-problems-quick-map" style="color:rgb(26,127,55)">How to find problems (quick map)</h3>
...
<h3 id="trace-compare" style="color:rgb(26,127,55)">Trace Compare</h3>
...
<h3 id="ai-assistant" style="color:rgb(26,127,55)">AI Assistant</h3>
...
<h3 id="opening-the-web-app-from-file" style="color:rgb(26,127,55)">Opening the web app from <code>file://</code></h3>
...
<h2 id="statistics--metrics" style="color:rgb(9,105,218);border-bottom:2px solid rgba(9,105,218,0.35);padding-bottom:0.35em">Statistics &amp; metrics</h2>

Shared by the Desktop **Statistics** tab and the Web **Statistics** panel.

<h3 id="in-this-section" style="color:rgb(26,127,55)">In this section</h3>
...
<h3 id="statistics-metric-tables" style="color:rgb(26,127,55)">Statistics metric tables</h3>
...
<h4 id="summary-scheduling-and-core-utilisation" style="color:rgb(130,80,223)">Summary, scheduling, and core utilisation</h4>
...
<h4 id="trace-health-tick" style="color:rgb(130,80,223)">Trace Health (TICK)</h4>
...
<h4 id="core-time-breakdown" style="color:rgb(130,80,223)">Core Time Breakdown</h4>
...
<h4 id="concurrent-core-active-distribution" style="color:rgb(130,80,223)">Concurrent Core Active Distribution</h4>
...
<h4 id="kernel-switch-overhead" style="color:rgb(130,80,223)">Kernel Switch Overhead</h4>
...
<h4 id="top-tasks-by-cpu" style="color:rgb(130,80,223)">Top tasks by CPU</h4>
...
<h4 id="core-affinity" style="color:rgb(130,80,223)">Core Affinity</h4>
...
<h4 id="task-lifecycle" style="color:rgb(130,80,223)">Task Lifecycle</h4>
...
<h4 id="deadlines--cpu-budget" style="color:rgb(130,80,223)">Deadlines / CPU budget</h4>
...
<h3 id="execution-blocking-and-inter-arrival" style="color:rgb(26,127,55)">Execution, blocking, and inter-arrival</h3>
...
<h4 id="execution-time-per-slice" style="color:rgb(130,80,223)">Execution Time Per Slice</h4>
...
<h4 id="blocking-time" style="color:rgb(130,80,223)">Blocking Time</h4>
...
<h4 id="dispatch--scheduling-latency" style="color:rgb(130,80,223)">Dispatch / Scheduling Latency</h4>
...
<h4 id="inter-arrival-time" style="color:rgb(130,80,223)">Inter-Arrival Time</h4>
...
<h4 id="preemption-chain-analysis" style="color:rgb(130,80,223)">Preemption Chain Analysis</h4>
...
<h4 id="priority-inheritance" style="color:rgb(130,80,223)">Priority Inheritance</h4>
...
<h5 id="lmh-pattern-priority-inversion-geometry" style="color:rgb(191,57,137)">L/M/H pattern (priority inversion geometry)</h5>
...
<h4 id="mutex--semaphore-pairing" style="color:rgb(130,80,223)">Mutex / Semaphore pairing</h4>
...
<h4 id="queue" style="color:rgb(130,80,223)">Queue</h4>
...
<h4 id="interval-analysis" style="color:rgb(130,80,223)">Interval Analysis</h4>
...
<h5 id="pairing-algorithm" style="color:rgb(191,57,137)">Pairing algorithm</h5>
...
<h5 id="limitations" style="color:rgb(191,57,137)">Limitations</h5>
...
<h5 id="timeline-rendering" style="color:rgb(191,57,137)">Timeline rendering</h5>
...
<h4 id="tag-analysis" style="color:rgb(130,80,223)">Tag Analysis</h4>
...
<h5 id="interval-tab-time-between-samples" style="color:rgb(191,57,137)">Interval tab (time between samples)</h5>
...
<h3 id="core-migration-analysis" style="color:rgb(26,127,55)">Core migration analysis</h3>
...
<h4 id="highlight-a-migrating-task-on-the-timeline" style="color:rgb(130,80,223)">Highlight a migrating task on the timeline</h4>
...
<h4 id="inspect-migrations-involving-a-specific-core" style="color:rgb(130,80,223)">Inspect migrations involving a specific core</h4>
...
<h4 id="core-pair-migration-summary" style="color:rgb(130,80,223)">Core-Pair Migration Summary</h4>
...
<h4 id="migration--corridor-inspector" style="color:rgb(130,80,223)">Migration &amp; Corridor Inspector</h4>
...
<h4 id="trace-compare-1" style="color:rgb(130,80,223)">Trace Compare…</h4>
...
<h5 id="use-case-tickful-vs-tickless-performance-and-context-switches" style="color:rgb(191,57,137)">Use case: tickful vs tickless (performance and context switches)</h5>
...
<h3 id="metrics-distribution-charts" style="color:rgb(26,127,55)">Metrics Distribution Charts</h3>
...
<h4 id="cdf-overlay" style="color:rgb(130,80,223)">CDF overlay</h4>
...
<h2 id="export" style="color:rgb(9,105,218);border-bottom:2px solid rgba(9,105,218,0.35);padding-bottom:0.35em">Export</h2>
...
<h3 id="headless-cli-desktop-only" style="color:rgb(26,127,55)">Headless CLI (Desktop only)</h3>
...
<h2 id="settings" style="color:rgb(9,105,218);border-bottom:2px solid rgba(9,105,218,0.35);padding-bottom:0.35em">Settings</h2>
...
<h2 id="keyboard--mouse" style="color:rgb(9,105,218);border-bottom:2px solid rgba(9,105,218,0.35);padding-bottom:0.35em">Keyboard &amp; mouse</h2>

Shortcuts marked **(W)** are Web-only. Others work on Desktop and Web. On Web, press `?` for an on-screen cheat sheet.

<h3 id="file--tabs" style="color:rgb(26,127,55)">File &amp; tabs</h3>
...
<h3 id="view--zoom" style="color:rgb(26,127,55)">View &amp; zoom</h3>
...
<h3 id="edit--marks" style="color:rgb(26,127,55)">Edit &amp; marks</h3>
...
<h3 id="export-1" style="color:rgb(26,127,55)">Export</h3>
...
<h3 id="mouse" style="color:rgb(26,127,55)">Mouse</h3>
...
<h2 id="further-reading" style="color:rgb(9,105,218);border-bottom:2px solid rgba(9,105,218,0.35);padding-bottom:0.35em">Further reading</h2>
...
<h3 id="developer-notes" style="color:rgb(26,127,55)">Developer notes</h3>
...
<h2 id="contributors" style="color:rgb(9,105,218);border-bottom:2px solid rgba(9,105,218,0.35);padding-bottom:0.35em">Contributors</h2>
