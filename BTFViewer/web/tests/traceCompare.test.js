...
describe('new compare builders', () => {
  ...
  it('builds inter-arrival compare rows', () => {
    ...
    assert.match(csv, /Core Utilization/)
    ...
    assert.match(html, /<h2>Core Utilization<\/h2>/)
    ...
    assert.match(html, /hydrateTraceCompareCharts/)
    assert.match(html, /Preemption count profile/)
    assert.match(html, /Synchronization activity profile/)
    assert.match(html, /Load-balance trend/)
    assert.match(html, /compare-chart-active/)
    assert.match(html, /compare-bar-in/)
    ...
    assert.match(html, /html\[data-theme="dark"\] \.paired-fill\.a/)
    assert.match(html, /repeating-linear-gradient/)
    assert.match(html, /html\[data-theme="dark"\] \.cmp-chart-bar\.minus/)
