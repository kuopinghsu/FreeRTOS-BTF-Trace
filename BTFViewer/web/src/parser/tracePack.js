...
export function packTrace(trace, progress) {
  ...
  return {
    ...
    payload: {
      ...
      prioritySummaryByMk: packPlainMap(trace.prioritySummaryByMk),
      hasPriorityInstrumentation: !!trace.hasPriorityInstrumentation,
      syncObjects: packPlainMap(trace.syncObjects),
      syncIssues: trace.syncIssues || [],
      hasSyncObjectInstrumentation: !!trace.hasSyncObjectInstrumentation,
...
export function unpackTrace(packed) {
  ...
  const trace = {
    ...
    prioritySummaryByMk: unpackPlainMap(p.prioritySummaryByMk || []),
    hasPriorityInstrumentation: !!p.hasPriorityInstrumentation,
    syncObjects: unpackPlainMap(p.syncObjects || []),
    syncIssues: p.syncIssues || [],
    hasSyncObjectInstrumentation: !!p.hasSyncObjectInstrumentation,
