...
SECTION_MARKERS: dict[str, str] = {
    ...
    "analysis_context": "# Analysis Context strip",
    "cursor_scope": "# Cursor Scope banner",
    "evidence_history": "# Evidence inspector history",
    "evidence_strength": "# Evidence-strength labels",
    "ai_tool_usage": "# Authoritative AI tool-usage record",
    "ai_response_flow": "# AI response flow — one block per query",
    "findings_triage": "# Findings triage queue",
    "stats_symptom_landing": "# Statistics symptom shortcuts",
    "stats": "# Main Window",
    "mvvm/base": "# MVVM",
